...
export default function Reservations() {
    ...
    const handleSubmit = (e) => {
        ...
        const { error: validationError } = schema.validate(Resdata, { abortEarly: false });
        ...
        const Existing_Reservations = JSON.parse(localStorage.getItem('User_Reservations')) || [];

        const Update_Reservations = [...Existing_Reservations, Resdata];

        localStorage.setItem('User_Reservations', JSON.stringify(Update_Reservations));
    ...
    return <>
        < HelmetProvider >
            <Helmet>
                ...
                <meta name='description' content='here you can book a table for your night remotly and just come when it is the time' />
            </Helmet>
        </HelmetProvider >
        <div className="res">
            <div className="container-fluid">
                <div className="header row">
                    ...
                    <div className="col-5 right">
                        <p><Link to={"/"}>home</Link> / Reservations</p>
                    </div>
                </div>
            </div>
            <div className="container-fluid">
                <form className="reservation_form row" onSubmit={handleSubmit}>
                    ...
                    <div className="input-container col-5">
                        ...
                        <input type="text" name="FullName" placeholder='Full name' required id="" value={Resdata.FullName} onChange={handleChange} />
                    </div>
                    <div className="input-container col-5">
                        <i className="fa-solid fa-phone"></i>
                        <input type="text" name="Phone" placeholder='phone number' required id="" value={Resdata.Phone} onChange={handleChange} />
                    </div>
                    <div className="input-container col-5">
                        <input type="number" name="Guests" placeholder='number of guests' required id="" value={Resdata.Guests} onChange={handleChange} />
                    </div>
                    <div className="input-container col-5">
                        <input type="date" name="Date" required id="" value={Resdata.Date} onChange={handleChange} />
                    </div>
                    <div className="textarea-container col-12">
                        <i className="fa-solid fa-comment"></i>
                        <textarea cols="10" rows="10" name="additional_notes" placeholder='additional notes (optional)' value={Resdata.additional_notes} onChange={handleChange} id=""></textarea>
                    </div>
                    <p className="error">{error}</p>
                    <div className="col-10 notice">
                        <p>* kindly note we will contact you on the provided phone number 48 hours before reservation for extra information and confirmation</p>
                    </div>
