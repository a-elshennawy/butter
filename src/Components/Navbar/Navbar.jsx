...
export default function Navbar() {
    ...
    return <>
                ...
                <div className="navbar row">
                    ...
                    <div className="navigations row col-10">
                        ...
                        <div className="orders col-1">
                            <Link to={'./orders'}><i className="fa-solid fa-mug-hot"></i></Link>
                        </div>
                        <div className="user col-3">
                            <span>{username ? `hello, ${username}` : 'hello, guest'}</span>
                            <i onClick={handleLogout} className="fa-solid fa-person-walking-arrow-right"></i>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <a className="offCanTrigger btn" data-bs-toggle="offcanvas" href="#offcanvasExample" role="button" aria-controls="offcanvasExample">
            <i className="fa-solid fa-bars"></i>
        </a>
        <div className="offcanvas offcanvas-start" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
            <div className="offcanvas-header">
                <h5 className="offcanvas-title" id="offcanvasExampleLabel"><span>{username ? `hello, ${username}` : 'hello, guest'}</span> </h5>
                <button type="button" className="btnClose" data-bs-dismiss="offcanvas" aria-label="Close">
            ...
            <div className="offcanvas-body">
                ...
                <div className="bottomBanner row">
                    <div className="socials col-6">
                        <Link to={"/blog"}><i className="fa-brands fa-facebook-f"></i></Link>
                        <Link to={"/blog"}><i className="fa-brands fa-twitter"></i></Link>
                        <Link to={"/blog"}><i className="fa-brands fa-instagram"></i></Link>
                    </div>
